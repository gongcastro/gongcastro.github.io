...
Briefly, NIRS is an imaging technique that takes advantage of the fact that different biological tissues absorb light differently. Biological tissues are made of molecules, some of which absorb light (i.e., chromophors). Some chromophores absorb more light at specific frequencies than others. The idea is that, by measuring how light travels through tissue, we may be able to get an idea of the composition of that tissue. Haemoglobin is one of the chromophores that has received the most attention in NIRS. This is because the oxygenated (oxy-haemoglobin, HbO) and deoxygenated (deoxy-haemoglobin, HbR) forms of haemoglobin absorb light at different extremes of the near-infrared (NIR) frequency spectrum. This has two consequences of interest: (1) most biological tissues are transparent (do not absorb) NIR light, which means that NIR light will not be affected by tissues other than haemoglobin, and (2) te fact that HbO and HbR absorb light at two different extremes of the NIR spectrum means that we can estimate how much HbO there is in the lit tissue, relative to HbR, by quantifying the frequency of the light that we can capture after the light has traveled through the tissue (a technique called *spectroscopy*, therefore the *S* in NIRS). The proportion of HbO over HbR can be interpreted as a proxy of metabolic activity in the tissue. In the case of neuroimaging, it provies an estimation of neural activity in certain brain areas.

NIRS devices shine a light into a tissue from a source. The light travels through the tissue and is received by a detector. By estimating how much of the light gets attenuated, and by observing the spectral properties of the received light, NIRS provides an estimation of the presence of certain chromophores in the tissue. The modified Beer-Lambert Law (mBBL) (see @eq-1) describes how the light attenuation ($A$) changes for a particular wave length ($\lambda$):
